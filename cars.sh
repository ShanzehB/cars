...
echo "This program will add cars to a file. Here is a list of options:"
...
do
	...
	then
		...
		echo "Thank you, I have added the car to the file"
	fi
	if [ "$OPTION" -eq "2" ]
	then
		echo "=================================================="
...
echo "=================================================="
echo "=================================================="
echo "Thank you. Proceed to the other file for info about your cars"
